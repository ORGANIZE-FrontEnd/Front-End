...
const HomeContent = () => {
  ...
  const cards = [
    ...
    { title: "Maiores Gastos do Mês", description: "Você não possui gastos no mês." },
    { title: "Contas a Receber", description: "Você não possui valores a receber." },
    { title: "Limite de Gastos", description: "Você não limitou gastos no mês." },
    { title: "Investimentos Mensais", description: "Você não fez investimentos." },
  ];
            ...
            >
              {card.title === "Minhas Contas" && (
                <>
                  ...
                  <h3 className="text-lg font-semibold text-left w-full">{card.title}</h3>
                </>
              )}
              ...
              {card.title !== "Minhas Contas" && (
                <div className="flex-grow flex items-center justify-center">
                  <div className="absolute inset-0 flex flex-col justify-center items-center">
                    <h3 className="absolute top-5 left-5 text-lg font-semibold">{card.title}</h3> 
